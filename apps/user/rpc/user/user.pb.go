...
func (x *GetUserResp) GetUser() *UserEntity {
	if x != nil {
		return x.User
	}
	return nil
...
func (x *GetAllUsersResp) GetUsers() []*UserEntity {
	if x != nil {
		return x.Users
	}
	return nil
...
const file_apps_user_rpc_user_proto_rawDesc = "" +
	...
	"\x05Token\x18\x01 \x01(\tR\x05Token\x12\x16\n" +
	"\x06expire\x18\x02 \x01(\x03R\x06expire\"\x1c\n" +
	"\n" +
	"GetUserReq\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\"3\n" +
	"\vGetUserResp\x12$\n" +
	"\x04user\x18\x01 \x01(\v2\x10.user.UserEntityR\x04user\"\x10\n" +
	"\x0eGetAllUsersReq\"9\n" +
	"\x0fGetAllUsersResp\x12&\n" +
	"\x05users\x18\x01 \x03(\v2\x10.user.UserEntityR\x05users\"I\n" +
	"\vFindUserReq\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x14\n" +
	"\x05phone\x18\x02 \x01(\tR\x05phone\x12\x10\n" +
	"\x03ids\x18\x03 \x03(\tR\x03ids\"4\n" +
	"\fFindUserResp\x12$\n" +
	"\x04user\x18\x01 \x03(\v2\x10.user.UserEntityR\x04user2\xa9\x02\n" +
	"\x04User\x12%\n" +
	...
	"\vGetAllUsers\x12\x14.user.GetAllUsersReq\x1a\x15.user.GetAllUsersResp\x121\n" +
...
var file_apps_user_rpc_user_proto_goTypes = []any{
	...
	(*GetAllUsersReq)(nil),  // 9: user.GetAllUsersReq
	(*GetAllUsersResp)(nil), // 10: user.GetAllUsersResp
	(*FindUserReq)(nil),     // 11: user.FindUserReq
	(*FindUserResp)(nil),    // 12: user.FindUserResp
}
var file_apps_user_rpc_user_proto_depIdxs = []int32{
	0,  // 0: user.GetUserResp.user:type_name -> user.UserEntity
	0,  // 1: user.GetAllUsersResp.users:type_name -> user.UserEntity
	...
	7,  // 6: user.User.GetUser:input_type -> user.GetUserReq
	9,  // 7: user.User.GetAllUsers:input_type -> user.GetAllUsersReq
	11, // 8: user.User.FindUser:input_type -> user.FindUserReq
	...
	8,  // 12: user.User.GetUser:output_type -> user.GetUserResp
	10, // 13: user.User.GetAllUsers:output_type -> user.GetAllUsersResp
	12, // 14: user.User.FindUser:output_type -> user.FindUserResp
